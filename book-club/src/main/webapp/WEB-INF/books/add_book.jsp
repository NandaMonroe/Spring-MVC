...
<body>
    <div class="container-sm mt-5 w-75 bg-primary p-5 rounded-5">
        ...
        <form:form action="/books/adding" method="POST" modelAttribute="book">

            <input type="hidden" name="user" value="${userId}"/>
            
            <div class="form-group mb-3">
                <form:label path="title">Title:</form:label>
                <form:input path="title" class="form-control" placeholder="Enter the book's title"/>
                <form:errors path="title"/>
            </div>

            <div class="form-group mb-3">
                <form:label path="author">Author:</form:label>
                <form:input path="author" class="form-control" placeholder="Enter the book's author"/>
